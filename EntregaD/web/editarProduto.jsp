<%-- 
    ...
    Created on : 31/03/2021, 14:59:03
    Author     : joaop
--%>
...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- TITULO  +  BOTÃO DE EDITAR PRODUTO -->
            <div class="d-flex flex-row justify-content-between align-items-center m-5">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 d-flex justify-content-end align-items-center p-2">
                    <a href="ProdutoController?acao=listar" class="btn btn-primary"><i class="fas fa-list"></i> Listar Produtos</a>
                </div>
            </div> <!-- ROW -->

            <!-- Formulário do Produto -->
            <jsp:include page="components/formProduto.jsp" />
        </div>
