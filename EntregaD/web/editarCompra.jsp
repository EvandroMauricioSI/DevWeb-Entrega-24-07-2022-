<%-- 
    ...
    Created on : 06/03/2021, 21:08:05
    Author     : joaop
--%>
...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- TITULO  +  BOTÃO DE ADICIONAR COMPRA -->
            <div class="d-flex flex-row justify-content-between align-items-center m-5">
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-start align-items-center p-2">
                    <h3><b>Editar Compra</b></h3>
                </div>

                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-end align-items-center p-2">
                    <a href="CompraController?acao=listar" class="btn btn-primary"><i class="fas fa-list"></i> Listar Compras</a>
                </div>
            </div> <!-- ROW -->

            <!-- Formulário de Compra -->
            <jsp:include page="components/formCompra.jsp" />
        </div>
