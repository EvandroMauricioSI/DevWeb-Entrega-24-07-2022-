<%-- 
    Document   : inserirFornecedor
    Created on : 15/03/2021, 20:38:06
    Author     : joaop
--%>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-row justify-content-between align-items-center m-5">
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-start align-items-center p-2">
                    <h3><b>Adicionar Fornecedor</b></h3>
                </div>

                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-end align-items-center p-2">
                    <a href="FornecedorController?acao=listar" class="btn btn-primary"><i class="fas fa-list"></i> Listar Fornecedores</a>
                </div>
            </div> <!-- ROW -->

            <!-- Formulário do Fornecedor -->
            <jsp:include page="components/formFornecedor.jsp" />
        </div>
