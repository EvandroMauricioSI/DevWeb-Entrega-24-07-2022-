<%-- 
    ...
    Created on : 15/03/2021, 17:29:59
    Author     : joaop
--%>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-row justify-content-between align-items-center m-5">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-end align-items-center p-2">
                    <a href="FornecedorController?acao=inserir" class="btn btn-primary"><i class="fas fa-plus"></i> Adicionar Novo Fornecedor</a>
                </div>
            </div> <!-- ROW -->
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover table-sm">
                    ...
                    %>
                    <caption>Lista de Fornecedores - Total: <%= todosFornecedores.size() %></caption>
                    ...
                    <tbody>
                        <%
                            ...
                            for (int index = 0; index < todosFornecedores.size(); index++) {
                                ...
                                String linkEditar = "FornecedorController?acao=editar&id=" + umFornecedor.getId();
                                String linkExcluir = "FornecedorController?acao=excluir&id=" + umFornecedor.getId();
                        %>
                            <tr>
                                <td class="cnpj"><%= umFornecedor.getCnpj() %></td>
                                <td><%= umFornecedor.getRazaoSocial() %></td>
                                <td class="telefone"><%= umFornecedor.getTelefone() %></td>
                                <td><%= umFornecedor.getEmail() %></td>
